        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div id="min_produk" class="col-3 col-md-2 d-flex justify-content-center mt-1">
                          ...
                          <input type="number" id="qty_produk" value=0 readonly class="col-2 col-md-2 d-flex justify-content-center" required>
            ...
            <div class="mb-3">
                ...
                <option @if(!session()->has('kota'))selected @endif disabled>Pilih Kabupaten/kota</option>           
                <option @if(session()->has('kota')) selected @endif value="Kota Pontianak" name="kota">Kota Pontianak</option>
            ...
            <div class="mb-3">
                ...
                <textarea required id="alamat_lengkap" class="form-control form-non-danger f-poppins" rows="3">@if(session()->has('alamat_lengkap')) {{session()->get('alamat_lengkap')}} @endif</textarea>
            </div>
...
<script>
                        ...
                        if(x > 0){
                            if(x == 1){
                                ...
                                x--;
                                $('#qty_produk').val(x);
                                var jumlah_barang = $('#qty_produk').val();
                    ...
                    $('#plus_produk').click(function (e) { 
                        ...
                        $('#lanjut_transaksi').click(function (e) { 
                            ...
                            $.ajax({
                                type: "POST",
                                url: "/ajaxRequest",
                                data: {nama:nama,no_wa:no_wa,keluhan:keluhan,kota:kota,provinsi:provinsi,alamat_lengkap:alamat_lengkap,qty_produk:qty_produk},
                                // dataType: "dataType",
